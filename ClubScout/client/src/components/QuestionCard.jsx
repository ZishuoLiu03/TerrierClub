        ...
        {question.options.map((option, idx) => (
          <button
            ...
            className=" w-full text-left p-4 rounded-xl 
                        ...
                        hover:border-[#B5182A] hover:bg-red-50/70 
          ...
          >
            <div className="flex items-start gap-3">
              <div className="mt-1 h-7 w-7 rounded-full flex items-center justify-center 
                            ...
                            group-hover:border-[#B5182A] 
                            group-hover:text-[#B5182A]
                ">
                {String.fromCharCode(65 + idx)}
              </div>

              <p className="text-sm md:text-base text-slate-800 group-hover:text-slate-900">
                {option.text}
              </p>
            </div>
          </button>
